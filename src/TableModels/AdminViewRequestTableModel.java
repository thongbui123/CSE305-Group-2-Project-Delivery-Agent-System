...
public class AdminViewRequestTableModel extends AbstractTableModel{
    ...
    public AdminViewRequestTableModel(ArrayList<Courier_Request> listRequest){
        ...
        for (int i = 0; i < this.listdata.size(); i++) {
            ...
            Object[] row ={cr.getCourierReqestID(),cr.getUsernameR(),cr.getEmailR(),cr.getDesciptionR(),cr.getApproxWeightR(),cr.getDestinationR(),cr.getAddressR(),cr.getPhoneNumberR()};
